...
class FileManager
{
	function newFolder($location, $dirname)
	{
		...
		if(strlen($dirname) > 0)
		{
			...
			else if(!chmod($location->getDir(true, false, false, 0).$dirname, Simplex::getConfig("confModeNewDir")))
			{
...
<div class="row">
<div class="col-xs-12 text-center">
<h4 class="no-strong"><?php if(Simplex::getConfig('confTitle') != null) print Simplex::getConfig('confTitle');?> with <a href="https://github.com/rfmaths/rfSimplex">Simplex</a></h4>
</div>
</div><!-- row -->
</div><!-- container -->
...
<h4 class="no-strong"><?php if(Simplex::getConfig('confTitle') != null) print Simplex::getConfig('confTitle');?> with <a href="https://github.com/rfmaths/frSimplex">Simplex</a></h4>
</div>
